...
\begin{itemize}
	\item An \gls{adiabatic} \index{Adiabatic} process is one in which no heat flows.  Adiabatic processes take place in either a perfectly insulated environment or happen quickly enough that the amount of heat that flows into or out of the surrounding environment is negligible. 
	
	\item An \gls{isothermal} \index{isothermal} process is one in which the temperature remains constant throughout the process.  This is done by adding or removing heat from the system.  
	
	\item In an \gls{isobaric} \index{isobaric} process, the pressure of the sample remains constant.  
	
	\item Finally, in an \gls{isochoric} \index{isochoric} process, the volume of the gas does not change.  This is sometimes called isovolumetric. 
	\end{itemize}

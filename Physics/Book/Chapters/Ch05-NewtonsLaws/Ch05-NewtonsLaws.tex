...
\begin{mdframed}[backgroundcolor=blue!10!white]
	...
	\textbf{Problem: } As a person walks through an airport, she pulls a suitcase at a constant speed using a strap at a 25\textdegree angle above horizontal.  Friction is significant.  Draw a free body diagram of the situation.
	\vspace{0.1in}

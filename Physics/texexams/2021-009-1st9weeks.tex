...
According to Graph 1, what is the average speed of this object from 0 to 10 seconds?
\choice{100 m/s}
\choice{20 m/s}
\choice[!]{2 m/s}
\choice{0.5 m/s}
...
\begin{question}
According to graph 1, during what time interval is the object traveling backward?
\choice{0-10 seconds}
...
%\begin{question}
%Billy throws a baseball upward and then catches it.  If upward is to be the positive %direction, which graph best represents the baseball's  velocity over time?
...
%	width=1.5in
%	]
%	\addplot[  domain=-10:10, range=-10:10,
%samples=100, 
%color=red,] {-x+6};
%	\end{axis}
%	\end{tikzpicture}}
